add_se.lm <- function(model,name_f,name_x="Intercept",type="response"){
  ...
  base_names <- paste0(name_f,levels(model$model[,name_f]),":",name_x)
  if(name_x=="Intercept"){
